...
public final class RecursiveLocalSearchExecutor implements ILocalSearchExecutor
{
    private final ILocalSearchResultFactory localSearchResultFactory;

    public RecursiveLocalSearchExecutor(ILocalSearchResultFactory localSearchResultFactory)
    {
