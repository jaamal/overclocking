...
public class ClassicLocalSearchExecutorTests extends UnitTestBase
{

    private IProductsPreprocessor preprocessor = new ProductsPreprocessor(new ProductFactory());
    private ClassicLocalSearchExecutor localSearchExecutor;
    ...
    private void setUp(dataContracts.Product[] pattern, dataContracts.Product[] text)
    {
        ...
        localSearchExecutor = new ClassicLocalSearchExecutor(new LocalSearchResultFactory());
