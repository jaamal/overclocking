...
import patternMatching.fcpm.localsearch.IterativeLocalSearchExecutor;
...
public class IterativeLocalSearchExecutorTest extends UnitTestBase
{

    private IProductsPreprocessor preprocessor = new ProductsPreprocessor(new ProductFactory());
    private IterativeLocalSearchExecutor localSearchExecutor;
    ...
    private void setUp(dataContracts.Product[] pattern, dataContracts.Product[] text)
    {
        ...
        localSearchExecutor = new IterativeLocalSearchExecutor(new LocalSearchResultFactory());
