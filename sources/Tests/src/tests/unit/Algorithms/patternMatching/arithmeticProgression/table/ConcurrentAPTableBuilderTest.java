...
public class ConcurrentAPTableBuilderTest extends UnitTestBase
{
    private IAPTableBuilder apTableBuilder;
    private patternMatching.fcpm.preprocessing.ProductsPreprocessor ProductsPreprocessor;
    ...
    public void setUp()
    {
        ...
        IPatternMatchingConfig multiThread = new IPatternMatchingConfig()
        {
            ...
            public TextsIterationStrategy getTextsIterationStrategy() {
                return TextsIterationStrategy.Interval;
            }
        ...
        apTableBuilder = tableBuilderFactory.create(multiThread);
