...
@AlgorithmType(algorithmType = CompressionAlgorithmType.slpClassic)
public class SLPClassicStatistics extends CompressionStatsBase implements ICompressionStats {
