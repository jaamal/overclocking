...
(function (d) {
    ...
    d.jqplot.Highlighter.postPlotDraw = function () {
        ...
        var h = this.plugins.highlighter;
        h._tooltipElem = d('<div class="jqplot-highlighter-tooltip" style="position:absolute;display:none"></div>');
        this.eventCanvas._elem.before(h._tooltipElem)
    };
